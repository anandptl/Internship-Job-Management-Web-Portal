...
<body>
    <div class="container">
        ...
        <aside class="sidebar">
            ...
            <nav>
                <a href="<c:url value='/manage-profile'/>" target="main_frame">
                    <button type="button">Manage Profile</button>
                </a>
                <button onclick="window.location.href='stuUp.html'">Apply for Jobs</button>
        ...
        <main class="main-content">
            ...
            <section id="profile" class="content-section active">
                ...
                <form id="profile-form" action="updateStu.jsp" method="post" enctype="multipart/form-data">
                        ...
                        <div class="input-group">
                            ...
                            <div class="file-upload">
                                ...
                                <label for="resume" class="file-upload-label">
                                    ...
                                    <div class="file-info">PDF or DOCX (Max 5MB)</div>
                                </label>
                            </div>
                        </div>
